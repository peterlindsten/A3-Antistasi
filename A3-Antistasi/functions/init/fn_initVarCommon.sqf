...
switch (toLower worldName) do {
	case "tanoa":
	{
		...
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Tanoa.sqf";
	};
	case "altis":
	{
		...
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Altis.sqf";
	};
	case "chernarus_summer":
	{
		...
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Cherna.sqf";
	};
	case "cup_chernarus_A3":
	{
		...
		roadsX setVariable ["airport_2",[[[4717.95,2595.24,12.9766],0,"AA"],[[4714.27,2590.97,8.97349],176.197,"MG"],[[4743.55,2567.69,0.0130215],207.155,"Tank"],[[4775.62,2547.37,0.00691605],210.579,"Tank"],[[4719.88,2582.34,0.00566483],261.79,"AT"],[[4826.5,2558.35,0.00150108],0,"Mort"],[[4821.12,2550.32,0.00147152],0,"Mort"],[[4816.59,2543.65,0.00147247],0,"Mort"],[[4812.77,2518.77,0.00566483],150.397,"AT"]]];
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Cherna2020.sqf";
	};
	...
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Malden.sqf";
	};
	case "enoch":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Livonia.sqf";
	};
	case "kunduz":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Kunduz.sqf";
	};
	case "takistan":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Takistan.sqf";
	};
	case "tembelan":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Tembelan.sqf";
	};
	case "tem_anizay":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\Anizay.sqf";
	};
	case "tem_kujari":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\kujari.sqf";
	};
	case "vt7":
	{
		//Roads DB
		call compile preprocessFileLineNumbers "\antistasi_client\data\roads\virolahti.sqf";
	};
};
