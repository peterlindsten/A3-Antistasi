class a3c_vehicle_manager
{
	...
	class Controls
	{
		class menu1 : a3cMenuButton 
		{
			...
			action = "closeDialog 0;nul = createDialog ""a3c_garage_sell"";";
		...
		class menu2 : a3cMenuButton 
		{
			...
			action = "closeDialog 0; if (player == theBoss) then {nul = createDialog ""a3c_squad_manager""} else {hint ""Only Player Commander has access to this function""};";
