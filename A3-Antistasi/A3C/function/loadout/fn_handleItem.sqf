...
_details = [_item] call a3c_fnc_fetchCfgDetails;
    ...
    switch (_details select 6) do {
        ...
        case "CfgVehicles": {
            ...
            if (!isNil "_items") then {
                {[_x,true,true,false,true] call a3c_fnc_handleItem; } forEach _items;
            };
        };
                ...
                switch (_details select 5) do {
                        ...
                        if (_ispack) then {
                            ...
                            if (_override) then{
                                ...
                                if (vest player isEqualTo _item && {!_preview}) then {
                                    ...
                                    if (!isNil "_items") then {
                                        {[_x,true,false,false,true] spawn a3c_fnc_handleItem;} forEach _items;
                                    };
                                };
                            };
                        };
                    ...
                    case 201: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,201] call a3c_fnc_accType;
                            if (_ongun) then {
                                switch (_type) do {
                                ...
                                if (_override) then {
                                    ...
                                    if (_slotTaken) then {
                                        _action = ["STR_MISC_AttachmentMSG","STR_MISC_Attachment","STR_MISC_Weapon","STR_MISC_Inventory"] call BIS_fnc_guiMessage;
                                        if (_action) then {
                                            switch (_type) do {
                                                case 1: {player addPrimaryWeaponItem _item;};
                                                case 2: {player addSecondaryWeaponItem _item;};
                    ...
                    case 301: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,301] call a3c_fnc_accType;
                    ...
                    case 101:{
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,101] call a3c_fnc_accType;
