...
NATOPlayerLoadouts = [
	//Team Leader
	["blufor_teamLeader"] call A3A_fnc_getLoadout,
	//Medic
	["blufor_medic"] call A3A_fnc_getLoadout,
	//Autorifleman
	["blufor_machineGunner"] call A3A_fnc_getLoadout,
	//Marksman
	["blufor_marksman"] call A3A_fnc_getLoadout,
	//Anti-tank Scout
	["blufor_AT"] call A3A_fnc_getLoadout,
	//AT2
	["blufor_rifleman"] call A3A_fnc_getLoadout
];
...
vehNATOTransportHelis = ["CUP_B_CH47F_USA","CUP_B_MH47E_USA","CUP_B_MH60L_DAP_2x_US","CUP_B_MH60L_DAP_4x_US","CUP_B_UH60M_US","CUP_B_CH53E_USMC","CUP_B_MH60L_DAP_2x_USN","CUP_B_UH1Y_UNA_USMC"];
vehNATOAttackHelis = ["CUP_B_AH64_DL_USA","CUP_B_AH64D_DL_USA","CUP_B_AH6J_USA","CUP_B_AH6M_USA","CUP_B_AH1Z_Dynamic_USMC","CUP_B_UH1Y_Gunship_Dynamic_USMC"];
//UAV
