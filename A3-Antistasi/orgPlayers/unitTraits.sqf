...
switch (_typeX) do
	...
	case "I_G_Soldier_F":  {player setUnitTrait ["audibleCoef",0.8]; player setUnitTrait ["loadCoef",1.2]; _textX = "Rifleman role.<br/><br/>Riflemen are more suitable to silent sneak but have less carrying capacity"}; //reintroduced - 8th January 2020, Bob Murphy
	...
	case "B_G_Soldier_F":  {player setUnitTrait ["audibleCoef",0.8]; player setUnitTrait ["loadCoef",1.2]; _textX = "Rifleman role.<br/><br/>Riflemen are more suitable to silent sneak but have less carrying capacity"}; //added - 8th January 2020, Bob Murphy
